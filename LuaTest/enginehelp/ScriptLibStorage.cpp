...
#include <fstream>
#include <vector>
//#include "safe/eCRC32.h"
//#include "utilities/EncryptHelper.h"
...
/*
	...
	unsigned long crc32 = elex::safe::GetCRC32(uSize - pHeader->dwNodeOffset,const_cast<char*>(&vecBuff[0]) + pHeader->dwNodeOffset);
	...
	if (!elex::safe::ZlibDe(pTemp, uSize - pHeader->dwNodeOffset, &vecData[0], &dwTemp))
	{
		return S_FALSE;
	}
...
// IScriptLibStorage
long CScriptLibStorage::OpenStream(const std::wstring& strStreamName,elex::lua::IScriptLibStream** ppstm)
{
